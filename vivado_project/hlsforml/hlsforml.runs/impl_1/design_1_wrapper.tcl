namespace eval ::optrace {
  variable script "/media/thifj/923884033883E497/Linux_usable/hls4ml/vivado_project/hlsforml/hlsforml.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /media/thifj/923884033883E497/Linux_usable/hls4ml/vivado_project/hlsforml/hlsforml.cache/wt [current_project]
  set_property parent.project_path /media/thifj/923884033883E497/Linux_usable/hls4ml/vivado_project/hlsforml/hlsforml.xpr [current_project]
  set_property ip_repo_paths /media/thifj/923884033883E497/Linux_usable/hls4ml/projeto_hls_saida/myproject_prj/solution1/impl/ip [current_project]
  update_ip_catalog
  set_property ip_output_repo /media/thifj/923884033883E497/Linux_usable/hls4ml/vivado_project/hlsforml/hlsforml.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /media/thifj/923884033883E497/Linux_usable/hls4ml/vivado_project/hlsforml/hlsforml.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files /media/thifj/923884033883E497/Linux_usable/hls4ml/vivado_project/hlsforml/hlsforml.srcs/sources_1/bd/design_1/design_1.bd
