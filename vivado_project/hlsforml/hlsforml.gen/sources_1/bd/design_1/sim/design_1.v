...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_clkrst_cnt=3,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   ();
  ...
  wire [63:0]axis_dwidth_converter_0_M_AXIS_TKEEP;
  ...
  wire [319:0]axis_subset_converter_1_M_AXIS_TDATA;
  wire axis_subset_converter_1_M_AXIS_TREADY;
  wire axis_subset_converter_1_M_AXIS_TVALID;
  wire [31:0]myproject_0_layer7_out_TDATA;
  wire myproject_0_layer7_out_TREADY;
  wire myproject_0_layer7_out_TVALID;
  ...
  design_1_axis_subset_converter_0_0 axis_subset_converter_0
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s_axis_tdata(myproject_0_layer7_out_TDATA),
        .s_axis_tlast(1'b0),
        .s_axis_tready(myproject_0_layer7_out_TREADY),
        .s_axis_tvalid(myproject_0_layer7_out_TVALID));
  ...
  design_1_myproject_0_0 myproject_0
       (.ap_clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .input_layer_TDATA(axis_subset_converter_1_M_AXIS_TDATA),
        .input_layer_TREADY(axis_subset_converter_1_M_AXIS_TREADY),
        .input_layer_TVALID(axis_subset_converter_1_M_AXIS_TVALID),
        .layer7_out_TDATA(myproject_0_layer7_out_TDATA),
        .layer7_out_TREADY(myproject_0_layer7_out_TREADY),
        .layer7_out_TVALID(myproject_0_layer7_out_TVALID));
