...
-- Date        : Thu Mar 26 14:15:52 2026
-- Host        : thifjrog running 64-bit Ubuntu 24.04.3 LTS
-- Command     : write_vhdl -force -mode synth_stub
--               /media/thifj/923884033883E497/Linux_usable/hls4ml/vivado_project/hlsforml/hlsforml.gen/sources_1/bd/design_1/ip/design_1_myproject_0_0/design_1_myproject_0_0_stub.vhdl
...
entity design_1_myproject_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of design_1_myproject_0_0 : entity is "design_1_myproject_0_0,myproject,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of design_1_myproject_0_0 : entity is "design_1_myproject_0_0,myproject,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=myproject,x_ipVersion=1.0,x_ipCoreRevision=0,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_myproject_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_myproject_0_0 : entity is "HLS";
  attribute hls_module : string;
  attribute hls_module of design_1_myproject_0_0 : entity is "yes";
end design_1_myproject_0_0;

architecture stub of design_1_myproject_0_0 is
